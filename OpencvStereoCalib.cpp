...
StereoCalib(const vector<string>& imagelist, Size boardSize, float squareSize, bool displayCorners = false, bool useCalibrated=true, bool showRectified=true)
{
    ...
    rms = calibrateCamera(objectPoints, imagePoints[0], imageSize, cameraMatrix[0],
        distCoeffs[0], rvecs, tvecs,
        CALIB_ZERO_TANGENT_DIST | CALIB_FIX_K3 | CALIB_FIX_K4 | CALIB_FIX_K5 | CALIB_FIX_K6);

    rms = calibrateCamera(objectPoints, imagePoints[1], imageSize, cameraMatrix[1],
